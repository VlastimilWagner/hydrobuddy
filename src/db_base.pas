...
type
  ...
  public
    ...
    function SearchByField(const AFieldName, AValue: string): Boolean;
...
begin
  if not SearchByField(AKeyField, AKeyValue) then
...
function TDBBase.SearchByField(const AFieldName, AValue: string): Boolean;
begin
  Result := False;
  FDbf.First;
