...
type
  TDBsubstances = object
  private
    const DBName = 'substances.dbf';
...
constructor TDBsubstances.Init;
begin
  Createdb;
end;


procedure TDBsubstances.BasicPost(var MyDbf: TDbf);
begin
...
procedure TDBsubstances.Insert;
var
   MyDbf: TDbf;
begin
...
procedure TDBsubstances.Update;
var
   MyDbf: TDbf;
begin
  MyDbf := TDbf.Create(nil);
...
procedure TDBsubstances.Delete;
var
   MyDbf: TDbf;
begin
  MyDbf := TDbf.Create(nil);
...
function TDBsubstances.SearchByName(Name: string):boolean;
var
   MyDbf: TDbf;
   Res: boolean;
begin
...
procedure TDBsubstances.InsertDataFromDBVer100(var MyDbf: TDbf);
begin


end;

procedure TDBsubstances.InsertDataFromXMLRes(var MyDbf: TDbf);
var
