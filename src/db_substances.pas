...
type
  ...
  TDBSubstances = class(TDBBase)
  private
    FRowData: TSubstancesRecord;
  ...
  public
    constructor Create;
    property RowData: TSubstancesRecord read FRowData write FRowData;
  end;
...
constructor TDBSubstances.Create;
begin
  inherited Create('substances.dbf');
end;



procedure TDBSubstances.Createdb;
begin
  Dbf.fielddefs.Clear;
  Dbf.TableLevel := 7;
...
procedure TDBSubstances.AssignFields;
begin
  try
...
procedure TDBSubstances.AssignRowData;
begin
  try
...
procedure TDBSubstances.InsertDataFromDBVer100;
begin


end;

procedure TDBSubstances.InsertDataFromCSVRes;
var
   ...
   IsLiquid: boolean;
begin
   S := TLazarusResourceStream.Create('dbsubstances', 'CSV');
...
begin
  {$I db_substances_csv.lrs}
  DBSubstances := TDbSubstances.Create;
end.
